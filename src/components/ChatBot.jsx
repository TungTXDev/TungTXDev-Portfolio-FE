...
export default function ChatBot({ isDrawerOpen }) {
  ...
  const portfolioTips = [
    {
      text: "Collaborated closely with teams, PMs, and stakeholders to reach goals.",
      icon: Users,
    },
    {
      text: "Strong communication and positive teamwork foster great results.",
      icon: MessageCircle,
    },
    { text: "Quickly adapts to new technologies and workflows.", icon: Zap },
    { text: "Delivers tasks on time with high quality.", icon: Clock },
    {
      text: "Proactively suggests improvements to code and workflow.",
      icon: Wrench,
    },
    {
      text: "AI tools applied to boost productivity and work quality.",
      icon: Bot,
    },
    {
      text: "Experienced with React, Node.js, and many other technologies!",
      icon: Code,
    },
    {
      text: "Try playing the Meteor game at the top-right corner!",
      icon: Gamepad2,
    },
  ];
  ...
  useEffect(() => {
    const bubbleInterval = setInterval(() => {
      // Chỉ hiện bubble khi Drawer đang đóng và Modal đang đóng
      if (!isDrawerOpen && !showModal) {
        setShowBubble(true);
  ...
  const handleLightbulbClick = () => {
    const randomTip =
      portfolioTips[Math.floor(Math.random() * portfolioTips.length)];
  ...
  return (
    <>
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-400 text-sm">
                      Work effectively with teams, PMs, and stakeholders to
                      achieve shared goals through strong collaboration.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-400 text-sm">
                      Build strong relationships with positive attitude,
                      ensuring clear and effective communication across all
                      levels.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-400 text-sm">
                      Quick learner who embraces new technologies, workflows,
                      and team environments with enthusiasm.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-400 text-sm">
                      Consistently deliver high-quality work on time, taking
                      full ownership of assigned tasks and commitments.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-400 text-sm">
                      Proactively identify issues and contribute innovative
                      ideas to improve code quality and workflow efficiency.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-400 text-sm">
                      Leverage AI tools effectively to enhance productivity and
      ...
      {/* AI Robot */}
      <div 
    className="hidden md:block fixed z-50 transition-all duration-1000 ease-in-out"
    style={{
        // --- 1. TRẠNG THÁI ĐÓNG (!isDrawerOpen) ---
        // "-1.25rem" chính là class -left-5
        // "1%" chính là class bottom-[1%]
        // --- 2. TRẠNG THÁI MỞ (isDrawerOpen) ---
        // Bay sang phải và Bay lên trên
        left: isDrawerOpen ? "calc(100vw - 180px)" : "-1.25rem",
        // Mẹo: Dùng bottom cho cả 2 trạng thái để nó trượt dọc mượt mà
        // Khi mở: bottom = Chiều cao màn hình - 150px (tức là nó sẽ nằm sát đỉnh)
        bottom: isDrawerOpen ? "calc(100vh - 280px)" : "1%",
        transform: isDrawerOpen ? "scale(0.7)" : "scale(1)"
    }}
>
        <div className="relative">
          {/* Bubble */}
          {showBubble && !isDrawerOpen && (
